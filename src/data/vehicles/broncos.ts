...
export const broncos: Vehicle[] = [
...

  {
    ...
    drivetrain: {
      value: "4x4",
      definition: "Four-wheel-drive system.",
      analogy: "Grip from all corners.",
      buyerValue: "Trail confidence."
    },
...

  {
    ...
    engine: {
      ...
      definition: "Modern turbo engine choices with retro styling.",
      analogy: "Old-school jacket, modern running shoes.",
      buyerValue: "Classic look without old-car compromises."
    },
    ...
    transmission: {
      value: "Manual or automatic depending setup.",
      definition: "Gear system.",
...

  {
    ...
    horsepower: {
      value: 330,
      definition: "Engine output.",
      analogy: "More sprint power than the 2.3L.",
      buyerValue: "Feels stronger and more premium."
    },
    ...
    drivetrain: {
      value: "4x4",
      definition: "Four-wheel-drive.",
      analogy: "All corners helping.",
      buyerValue: "Off-road credibility."
    }
